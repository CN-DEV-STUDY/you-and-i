    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    buttonVariants({ variant: "calendarBtn" }),
                ...
                cell: "text-center w-11 text-sm p-0 relative first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
                day: cn(
...
PlanCalendar.displayName = "Calendar";
