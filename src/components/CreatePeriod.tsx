...
interface Props {
  onClick: () => void;
  onChangeSuccess: (status: boolean) => void;
  isSuccess: boolean;
}

function CreatePeriod({ onClick, onChangeSuccess }: Props) {
  // hook form
...
const Container = styled.div`
  ...
  box-shadow: 0 0 15px 10px rgba(94, 53, 177, 0.1),
    0 0 15px 12px rgba(94, 53, 177, 0.1), 0 0 15px 15px rgba(94, 53, 177, 0.1);
`;
